...
class MangaApp:
    ...
    def fetch_manga_image(self, url):
        ...
        try:
            ...
            # Redimensionner et afficher l’image dans le frame prévu
            img = img.resize((130, int(130 * img.height / img.width)))
            img_tk = ImageTk.PhotoImage(img)
            ...
            # Ajustement de la largeur seulement si l’image dépasse la fenêtre
            min_width = img.width + 40  # 10 de marge gauche + image + 30 de sécurité
